    ...
    <>
      ...
      <div className="container flex gap-4 sm:mx-auto sm:my-5 m-auto">
        <ul className="min-w-60 lg:flex lg:flex-col hidden text-slate-500 sm:rounded-3xl">
          <li className='flex items-center hover:bg-slate-100 px-4 rounded-md'>
            <i className="bi bi-person-lines-fill"></i>
            <Link className='w-full flex justify-between p-4 border-b hover:border-slate-50 border-slate-200' to='/'>
              Fondateur <i className="bi bi-chevron-right"></i>
            </Link>
          </li>
          <li className='flex items-center hover:bg-slate-100 px-4 rounded-md'>
            <i className="bi bi-eyeglasses"></i>
            <Link className='w-full flex justify-between p-4 border-b hover:border-slate-50 border-slate-200' to='/'>
              Vision <i className="bi bi-chevron-right"></i>
            </Link>
          </li>
          <li className='flex items-center hover:bg-slate-100 px-4 rounded-md'>
            <i className="bi bi-calendar-date"></i>
            <Link className='w-full flex justify-between p-4 border-b hover:border-slate-50 border-slate-200' to='/'>
              Calendar <i className="bi bi-chevron-right"></i>
            </Link>
          </li>
          <li className='flex items-center hover:bg-slate-100 px-4 rounded-md'>
          ...
          <li className='flex items-center hover:bg-slate-100 px-4 rounded-md'>
            ...
            <Link className='w-full flex justify-between p-4' to='/'>
              Contactez-nous <i className="bi bi-chevron-right"></i>
            </Link>
          </li>
        </ul>
