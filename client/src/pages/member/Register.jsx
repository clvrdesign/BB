    ...
    <div className="w-full h-screen bg-gray-100">
      <div className="max-w-[1200px] m-auto">
        <div className="flex flex-col gap-5">
          ...
          <div className="w-full md:min-h-auto min-h-screen bg-white md:pt-0 pt-5 md:pb-0 pb-5 md:px-[120px] px-3 md:my-0 my-10">
            <div className='sticky bg-white top-0 left-0 py-2 z-10'>
              <small>Inscription /
              ...
              <form className="w-full flex flex-col gap-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                  <div className="flex flex-col gap-1 mb-2">
                    <label className="text-gray-500" htmlFor="name">Nom (1)</label>
                    <input
                      type="text"
                      id='name'
                      placeholder="Butoyi"
                  ...
                  <div className="flex flex-col gap-1 mb-2">
                    <label className="text-gray-500" htmlFor="email">Nom (2)</label>
                    <input
                      type="text"
                      id='name2'
                      placeholder="Bukuru"
                  ...
                  <div className="flex flex-col gap-1 mb-2">
                    <label className="text-gray-500" htmlFor="prenom">Prénom (1)</label>
                    <input
                      type="text"
                      id='prénom'
                      placeholder="Marie"
                  ...
                  <div className="flex flex-col gap-1 mb-2">
                    <label className="text-gray-500" htmlFor="email">Prénom (2)</label>
                    <input
                      type="email"
                      id='email'
                      placeholder="Joseph"
                ...
                <div className="flex flex-col gap-1 mb-2">
                  ...
                  <div className="flex gap-10 h-10 bg-gray-100 px-4 rounded-md">
                    <div className="flex items-center gap-2">
                      <input type="radio" id='burundian' name="nationality" value="Burundi" className="h-4 w-4" />
                      <label htmlFor='burundian' className="text-gray-700">Burundi</label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input type="radio" id="notBurundian" name='nationality' value="Ami du Burundi" className="h-4 w-4" />
                      <label htmlFor='notBurundian' className="text-gray-700">Ami du Burundi</label>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col gap-1 mb-2">
                  ...
                  <div className="flex gap-10 h-10 bg-gray-100 px-4 rounded-md">
                    <div className="flex items-center gap-2">
                      <input type="radio" id="male" name='genre' value="Male" className="h-4 w-4" />
                      <label htmlFor="male" className="text-gray-700">Homme</label>
                    </div>
                    <div className="flex items-center gap-2">
                      <input type="radio" id="female" name='genre' value="Female" className="h-4 w-4" />
                      <label htmlFor="female" className="text-gray-700">Femme</label>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col gap-1 mb-2">
